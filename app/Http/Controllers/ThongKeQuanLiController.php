...
/*---------------------------Thống kê nhà bán hàng------------------------------*/
	public function getThongKeNhaBanHang(){
		...
		return view('quanli.thongke.thongke_nhabanhang')->with('chart', $chart)->with('nguoiban', $nguoiban);
	}
...
/*------------Thống kê doanh thu theo từng nhà bán hàng----------------*/
	public function getDoanhThu(){
		$nhabanhang = DB::table('nguoi_ban')->get();

		return view('quanli.thongke.thongke_doanhthu')->with('nhabanhang', $nhabanhang);
	}
